...
const double TICKS_PER_REVOLUTION = 370; // For reference purposes.
const double WHEEL_RADIUS = 0.06; // Wheel radius in meters
const double WHEEL_BASE = 0.5; // Center of left tire to center of right tire
const double TICKS_PER_METER = 976; // Original was 2800
...
void publish_quat() {
  ...
  quatOdom.child_frame_id = "base_link"; //base_link
